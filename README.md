...
This [application](https://seoseo.herokuapp.com/) allows you to analyze web pages for SEO. The application checks the availability of the specified page, the presence of the title and description. Information about the entered URLs and the results of the checks are stored in a database.
